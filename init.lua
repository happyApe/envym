...
-- Keep some lines to the left and right when scrolling horizontally
...
vim.keymap.set('n', '<leader>gt', ':Gitsigns toggle_linehl<CR>') -- Toggle the git line highlights
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        clangd = {},
        rust_analyzer = {},
        -- gopls = {}, -- Commented out - requires Go to be installed
